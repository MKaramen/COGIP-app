            ...
            <div class="col-8 offset-2">
                ...
                <form class="mt-5 text-center" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="people_phone" maxlength="10" class="form-control" id="phone" aria-describedby="phone" placeholder="Enter your phone number">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="company" name="people_company">
